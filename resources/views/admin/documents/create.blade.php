                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    @enderror
                                    <small class="text-muted">This will be displayed as the document name</small>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Brief description of the document (optional)</small>
                                </div>
                                ...
                                <div class="alert alert-info" id="file-info" style="display: none;">
