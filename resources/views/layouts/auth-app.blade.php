...
<head>
    ...
    <!-- Title -->
    <title>@yield('title', 'Login - Trusted LEI')</title>
    
    <meta name="description" content="@yield('description', 'Login to your Trusted LEI account to manage your LEI registrations')">
